...
namespace Impres\Translatee\Domain\Export\Exporters\Support;
...
class XliffNode
{
    ...
    protected static $mapNameToClass = [
        'xliff'     => 'Impres\Translatee\Domain\Export\Exporters\Support\XliffDocument',
        'file'      => 'Impres\Translatee\Domain\Export\Exporters\Support\XliffFile',
        'body'      => 'Impres\Translatee\Domain\Export\Exporters\Support\XliffFileBody',
        'header'    => 'Impres\Translatee\Domain\Export\Exporters\Support\XliffFileHeader',
        'group'     => 'Impres\Translatee\Domain\Export\Exporters\Support\XliffUnitsGroup',
        'trans-unit'=> 'Impres\Translatee\Domain\Export\Exporters\Support\XliffUnit',
...
class XliffDocument extends XliffNode
{
    ...
    protected $supportedContainers = [
        'files' => 'Impres\Translatee\Domain\Export\Exporters\Support\XliffFile',
    ];
    protected $version;
...
class XliffFileHeader extends XliffNode
{
    ...
    protected $supportedNodes = [
        'skl'    => 'Impres\Translatee\Domain\Export\Exporters\Support\XliffFileHeaderSKL',
    ];
}
class XliffFileHeaderSKL extends XliffNode
{
    protected $name           = 'skl';
    protected $supportedNodes = [
        'external-file'    => 'Impres\Translatee\Domain\Export\Exporters\Support\XliffFileHeaderExternalFile',
    ];
}
...
class XliffFileBody extends XliffNode
{
    protected $name                = 'body';
    protected $supportedContainers = [
        'groups'            => 'Impres\Translatee\Domain\Export\Exporters\Support\XliffUnitsGroup',
        'trans-units'       => 'Impres\Translatee\Domain\Export\Exporters\Support\XliffUnit',
    ];
}
/**
